...
#[no_mangle]
pub extern "system" fn Java_com_rebble_rusty_1libpebble2_1lib_RustyKt_helloDirect(
  env: JNIEnv,
  _: JClass,
  input: JString,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_com_rebble_rusty_1libpebble2_1lib_RustyKt_hello(
  env: JNIEnv,
  _: JClass,
  input: JString,
) -> jstring {
